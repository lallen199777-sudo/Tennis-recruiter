...
const COLLEGES = [
  ...
  ["Bates", "D3"], ["Colby", "D3"], ["Hamilton", "D3"], ["Skidmore", "D3"], ["Swarthmore", "D3"],
  ...
  ["Abilene Christian", "D1"], ["Texas State", "D1"], ["UTSA", "D1"], ["North Texas", "D1"],
...
function classifyDivision(utrStr, division) {
  const utr = parseFloat(utrStr);
  const range = DIVISION_RANGES[division];
  ...
  const filtered = useMemo(() => {
    ...
    return schools
      ...
      .filter((s) => {
        ...
        const cls = classifyDivision(profile.utr, s.division);
                  ...
                  {schoolSuggestOpen && schoolMatches.length > 0 && (
                    <div style={styles.suggestBox}>
                      {schoolMatches.map(([name, division]) => {
                        const cls = classifyDivision(profile.utr, division);
                        const clsStyle = cls ? CLASS_STYLE[cls] : null;
                        return (
                          <div
                            key={name}
